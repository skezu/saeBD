--Insertion rangs
INSERT INTO Rang VALUES (1, 'Classe S');
INSERT INTO Rang VALUES (2, 'Classe A');
INSERT INTO Rang VALUES (3, 'Classe B');
INSERT INTO Rang VALUES (4, 'Classe C');
INSERT INTO Rang VALUES (5, 'Dieu');
INSERT INTO Rang VALUES (6, 'Dragon');
INSERT INTO Rang VALUES (7, 'Demon');
INSERT INTO Rang VALUES (8, 'Tigre');

--Insertion personnages
INSERT INTO Personnage Values
    (1, 'Saitama', 'One Punch Man', 'Humain', 25, 'H', 'Saitama est un super-héros extrêmement puissant qui peut vaincre n importe quel ennemi en un seul coup.',1,1,1);
    INSERT INTO Personnage Values
    (2, 'Genos', 'Demon Cyborg', 'Cyborg', 19, 'H', 'Genos est un cyborg qui est disciple de Saitama et cherche à devenir plus fort.',1,1,1);
    INSERT INTO Personnage Values
    (3, 'Tatsumaki', 'Tornado of Terror', 'Humain', 28, 'F', 'Tatsumaki est une super-héroïne dotée de pouvoirs psychiques qui peut manipuler les objets avec sa télékinésie.',null,1,1);
    INSERT INTO Personnage Values
    (4, 'Bang', 'Silver Fang', 'Humain', 81, 'H', 'Bang est un maître des arts martiaux et le fondateur de l''Association des héros.',null,1,1);
    INSERT INTO Personnage Values
    (5, 'Fubuki', 'Blizzard of Hell', 'Humain', 23, 'F', 'Fubuki est une super-héroïne qui dirige le Groupe Blizzard, une équipe de héros de classe B.',null,2,1);
    INSERT INTO Personnage Values
    (6, 'Atomic Samurai', 'Atomic Samurai', 'Humain', 37, 'H', 'Atomic Samurai est un héros de classe S qui manie un sabre avec une précision mortelle.',null,1,1);
    INSERT INTO Personnage Values
    (7, 'Child Emperor', 'Child Emperor', 'Humain', 10, 'H', 'Child Emperor est un jeune prodige qui est membre de l''Association des héros.',null,1,1);
    INSERT INTO Personnage Values
    (8, 'Metal Knight', 'Metal Knight', 'Humain', 35, 'H', 'Metal Knight est un super-héros qui utilise des robots pour combattre les ennemis.',null,1,1);
    INSERT INTO Personnage Values
    (9, 'King', 'The Strongest Man on Earth', 'Humain', 29, 'H', 'King est un héros de classe S, mais en réalité, il est totalement sans pouvoir et vit de la réputation de Saitama.',null,1,1);
    INSERT INTO Personnage Values
    (10, 'Zombieman', 'Zombieman', 'Humain', 22, 'H', 'Zombieman est un héros immortel qui peut guérir de toutes les blessures.',null,1,1);
    INSERT INTO Personnage Values
    (11, 'Drive Knight', 'Drive Knight', 'X', 19, 'X', 'Drive Knight est un membre de classe S de l''Association des héros dont le véritable but et les motivations sont inconnus.',null,1,1);
    INSERT INTO Personnage Values
    (12, 'Pig God', 'Pig God', 'Humain', 24, 'H', 'Pig God est un héros de classe S qui a une apparence dégoûtante et possède une énorme appétit.',null,1,1);
    INSERT INTO Personnage Values
    (13, 'Superalloy Darkshine', 'Superalloy Darkshine', 'Humain', 29, 'H', 'Superalloy Darkshine est un héros de classe S doté d''une peau métallique et d''une force surhumaine.',null,1,1);
    INSERT INTO Personnage Values
    (14, 'Watchdog Man', 'Watchdog Man', 'X', 25, 'H', 'Watchdog Man est un héros mystérieux qui protège la ville de Q-City et est toujours accompagné de nombreux chiens.',6,1,1);
    INSERT INTO Personnage Values
    (15, 'Flashy Flash', 'Flashy Flash', 'Humain', 25, 'H', 'Flashy Flash est un héros de classe S extrêmement rapide et habile avec ses lames.',null,10,3);
    INSERT INTO Personnage Values
    (16, 'Tanktop Master', 'Tanktop Master', 'Humain', 37, 'H', 'Tanktop Master est un héros de classe S qui porte un débardeur et se spécialise dans les techniques de combat avec sa tenue.',null,1,1);
    INSERT INTO Personnage Values
    (17, 'Metal Bat', 'Metal Bat', 'Humain', 17, 'H', 'Metal Bat est un héros de classe S qui se bat avec une batte de métal et devient plus fort à mesure qu''il subit des blessures.',null,1,1);
    INSERT INTO Personnage Values
    (18, 'Puri-Puri Prisoner', 'Puri-Puri Prisoner', 'Humain', 22, 'H', 'Puri-Puri Prisoner est un héros de classe S qui a une apparence de prisonnier et possède une force immense.',null,1,1);
    INSERT INTO Personnage Values
    (19, 'Amai Mask', 'Amai Mask', 'Humain', 26, 'H', 'Amai Mask est un héros de classe A qui est également une célèbre idole et se soucie beaucoup de son apparence.',null,1,1);
    INSERT INTO Personnage Values
    (20, 'Sonic', 'Speed-o''-Sound Sonic', 'Humain', 25, 'H', 'Sonic est un ninja professionnel et un rival de Saitama, il possède une vitesse et une agilité exceptionnelles.',null,10,3);
    INSERT INTO Personnage Values
    (21, 'Garou', 'Garou', 'Humain', 24, 'H', 'Garou est un ancien disciple de Bang et est devenu un chasseur de héros puissant, il souhaite devenir le monstre ultime.',null,null,7);
    INSERT INTO Personnage Values
    (22, 'Mumen Rider', 'Mumen Rider', 'Humain', 18, 'H', 'Mumen Rider est un héros de classe C qui fait de son mieux pour protéger les innocents malgré sa faiblesse.',null,1,1);
    INSERT INTO Personnage Values
    (23, 'Lily', 'Blizzard Group - Lily', 'Humain', 20, 'F', 'Lily est membre du Groupe Blizzard et utilise ses pouvoirs de manipulation de l''eau pour combattre les ennemis.',null,2,1);
    INSERT INTO Personnage Values
    (24, 'Piko', 'Blizzard Group - Piko', 'Humain', 25, 'H', 'Piko est membre du Groupe Blizzard et utilise des armes à feu pour se battre contre les ennemis.',null,2,1);
    INSERT INTO Personnage Values
    (25, 'Mizuki', 'Blizzard Group - Mizuki', 'Humain', 23, 'F', 'Mizuki est membre du Groupe Blizzard et utilise des attaques basées sur le son pour combattre les ennemis.',null,2,1);
    INSERT INTO Personnage Values
    (26, 'Sitch', 'Sitch', 'Humain', 30, 'H', 'Sitch est un membre important de l''Association des héros et joue un rôle clé dans la coordination des héros.',null,1,6);
    INSERT INTO Personnage Values
    (27, 'Dr. Genus', 'Dr. Genus', 'Humain', 50, 'H', 'Dr. Genus est le fondateur de l''House of Evolution, une organisation qui cherche à créer des êtres surhumains.',null,null,5);
    INSERT INTO Personnage Values
    (28, 'Mosquito Girl', 'Mosquito Girl', 'Monstre', 24, 'F', 'Mosquito Girl est un monstre créé par l''House of Evolution avec une apparence mi-humaine, mi-moustique.',null,5,2);
    INSERT INTO Personnage Values
    (29, 'Carnage Kabuto', 'Carnage Kabuto', 'Monstre', 25, 'H', 'Carnage Kabuto est un monstre créé par l''House of Evolution qui possède une force et une résistance incroyables.',null,4,2);
    INSERT INTO Personnage Values
    (30, 'Vaccine Man', 'Vaccine Man', 'Monstre', 20, 'X', 'Vaccine Man est un monstre puissant qui apparaît lors du premier incident de monstres dans l''histoire.',null,5,2);
    INSERT INTO Personnage Values
    (31, 'Deep Sea King', 'Deep Sea King', 'Monstre', 20, 'H', 'Deep Sea King est un monstre qui règne sur les océans et possède une force et une endurance incroyables.',null,12,2);
    INSERT INTO Personnage Values
    (32, 'Hammerhead', 'Hammerhead', 'Humain', 30, 'H', 'Hammerhead est un chef de gang qui utilise un casque en forme de marteau et cherche à renverser le système des héros.',null,9,7);
    INSERT INTO Personnage Values
    (33, 'Sea King', 'Sea King', 'Monstre', 27, 'H', 'Sea King est un monstre puissant qui attaque la ville et défie les héros pour combattre.',null,5,2);
...
-- Insertion de la table lieu   
    ...
    INSERT INTO EpisodeVille VALUES (1,1);
    INSERT INTO EpisodeVille VALUES (12,3);
    INSERT INTO EpisodeVille VALUES (23,5);
    INSERT INTO EpisodeVille VALUES (15,10);
    INSERT INTO EpisodeVille VALUES (3,2);
    INSERT INTO EpisodeVille VALUES (7,4);
    INSERT INTO EpisodeVille VALUES (8,6);
    INSERT INTO EpisodeVille VALUES (9,9);
    INSERT INTO EpisodeVille VALUES (12,1);
    INSERT INTO EpisodeVille VALUES (13,7);
    INSERT INTO EpisodeVille VALUES (24,8);
    INSERT INTO EpisodeVille VALUES (20,10);
    INSERT INTO EpisodeVille VALUES (1,3);
    INSERT INTO EpisodeVille VALUES (11,1);
    INSERT INTO EpisodeVille VALUES (14,10);
    INSERT INTO EpisodeVille VALUES (17,5);
    INSERT INTO EpisodeVille VALUES (19,6);
    INSERT INTO EpisodeVille VALUES (22,3);

    INSERT INTO ArcSaison VALUES (1,1);
    INSERT INTO ArcSaison VALUES (2,1);
    INSERT INTO ArcSaison VALUES (3,1);
    INSERT INTO ArcSaison VALUES (4,1);
    INSERT INTO ArcSaison VALUES (5,2);
    INSERT INTO ArcSaison VALUES (6,2);
    INSERT INTO ArcSaison VALUES (7,1);
    INSERT INTO ArcSaison VALUES (8,2);
    INSERT INTO ArcSaison VALUES (9,1);
    INSERT INTO ArcSaison VALUES (10,2);

    INSERT INTO SpecialitePersonnage VALUES (1,1);
    INSERT INTO SpecialitePersonnage VALUES (2,23);
    INSERT INTO SpecialitePersonnage VALUES (3,35);
    INSERT INTO SpecialitePersonnage VALUES (4,12);
    INSERT INTO SpecialitePersonnage VALUES (5,15);
    INSERT INTO SpecialitePersonnage VALUES (6,17);
    INSERT INTO SpecialitePersonnage VALUES (7,1);
    INSERT INTO SpecialitePersonnage VALUES (8,4);
